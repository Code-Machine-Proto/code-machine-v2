...
export default function VisualPolyRisc() {
  ...
  const nop =
    lineState == LineStatePolyRisc.nop ||
    opTwoReg ||
    opThreeReg ||
    load ||
    store ||
  ...
  return (
    ...
    >
      ...
      <use
        href='#ir-rsrc2'
        className={opThreeReg || store ? 'fill-red-500' : ''}
      />
      <use href='#ir-pc' className={branching ? 'fill-red-500' : ''} />
      <use
        href='#reg-A'
        className={opTwoReg || opThreeReg ? 'fill-red-500' : ''}
      />
      ...
      <ObscureMemory
        ...
        y={70}
      >
        <text x={5} y={182} dominantBaseline='middle' fill='black'>
          addr
        </text>
        <text
          x={165}
      ...
      >
        <text x={5} y={35} dominantBaseline='middle' fill='black'>
          data_in
        </text>
        <text x={5} y={201} dominantBaseline='middle' fill='black'>
          rdst
        </text>
        <text x={5} y={238} dominantBaseline='middle' fill='black'>
          rsrc1
        </text>
        <text x={5} y={275} dominantBaseline='middle' fill='black'>
          rsrc2
        </text>
        <text
          x={165}
      ...
      <ObscureMemory
        ...
        isWritable={store}
      >
        <text x={5} y={132.5} dominantBaseline='middle' fill='black'>
          addr
        </text>
        <text x={5} y={264} dominantBaseline='middle' fill='black'>
          data_in
        </text>
        <text
          x={165}
      ...
      <circle
        ...
        r='5'
        className={
          opTwoReg || opThreeReg || branching || load || store || loadI
            ? 'fill-red-500'
            : 'fill-white'
        }
      />
      <circle
        ...
        cy='217'
        r='5'
        className={opThreeReg || store ? 'fill-red-500' : 'fill-white'}
      />
