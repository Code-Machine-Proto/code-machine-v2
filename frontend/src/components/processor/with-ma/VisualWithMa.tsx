    ...
    >
     ...
     155.448 585.448 155 586 155H615V97C615 96.4477 615.448 96 616 96H841Z'
      ...
      <use
        href='#mux3-mem'
        className={
          fetch || addr || addSubX || loadI || storeI ? 'fill-red-500' : ''
        }
      />
      <use
        href='#mem-alu'
        className={addSubMul || addSubA || addSubX ? 'fill-red-500' : ''}
      />
      ...
      <use
        href='#ma-addr'
        className={addSubX || loadI || storeI ? 'fill-red-500' : ''}
      />
      <use href='#ma-alu' className={addSubA ? 'fill-red-500' : ''} />
      <use
        href='#mux-mem'
        className={store || storeA || storeI ? 'fill-red-500' : ''}
      />
      <use
        href='#mux-alu'
        className={addSubMul || addSubA || addSubX || sh ? 'fill-red-500' : ''}
      />
      ...
      <Multiplexer
        ...
        y={40}
        name='sel_mem_data'
        isActivated={store || storeA || storeI}
      />
      <Multiplexer
        x={360}
        y={165}
      ...
      <Multiplexer
        ...
        y={200}
        name='alu_b_source'
        isActivated={addSubMul || addSubA || sh || addSubX}
      />
      <Multiplexer
        x={900}
        y={80}
      ...
      >
        <text x='5' y='70' dominantBaseline='middle' fill='black'>
          data_in
        </text>
        <text x='5' y='298' dominantBaseline='middle' fill='black'>
          addr
        </text>
        <text
          x='165'
      ...
      <circle
        ...
        r='5'
        className={
          fetch || addSubMul || addSubA || addSubX || load || loadA || loadI
            ? 'fill-red-500'
            : 'fill-white'
        }
      />
      <circle
        ...
        cy='97'
        r='5'
        className={load || loadA || loadI ? 'fill-red-500' : 'fill-white'}
      />
      <circle
        cx='865'
        cy='195'
        r='5'
        className={
          addSubMul || addSubA || addSubX || sh ? 'fill-red-500' : 'fill-white'
        }
      />
      <circle
        cx='1155'
        ...
        r='5'
        className={
          decode || addSubMul || addSubX || sh || store || storeI
            ? 'fill-red-500'
            : 'fill-white'
        }
      />
      <circle
        ...
        cy='203'
        r='5'
        className={branching || addr ? 'fill-red-500' : 'fill-white'}
      />
      <circle
        cx='1170'
        cy='257'
        r='5'
        className={
          addSubA || addSubX || loadI || storeA || storeI
            ? 'fill-red-500'
            : 'fill-white'
        }
      />
      <circle
        ...
        r='5'
        className={
          addSubA || addSubX || loadI || storeI ? 'fill-red-500' : 'fill-white'
        }
      />
      <circle
        cx='291'
        cy='110'
        r='5'
        className={fetch || nop ? 'fill-red-500' : 'fill-white'}
      />
      <circle
        cx='1155'
        cy='329'
      ...
      <g>
        ...
        <text
          ...
          x={728}
          y={382}
          className='text-xl font-semibold fill-black'
        >
          Control Signal
        </text>
      </g>
