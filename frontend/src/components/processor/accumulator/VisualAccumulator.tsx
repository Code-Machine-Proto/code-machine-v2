...
export default function VisualAccumulator() {
    ...
    return(
        <svg width="100%" height="100%" viewBox="0 0 1131 442" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
                id="pc-mux"
                d="M241 136C240.448 136 240 136.448 240 137C240 137.552 240.448 138 241 138V136ZM314 137L304 131.226V142.774L314 137ZM241 137V138H305V137V136H241V137Z"
                fill="white"
            />
            <path
                id="inc"
                d="M277 68C277.552 68 278 68.4477 278 69V137C278 137.552 277.552 138 277 138H241C240.448 138 240 137.552 240 137C240 136.448 240.448 136 241 136H276V70H3V109H18V104.227L28 110L18 115.773V111H2C1.44772 111 1 110.552 1 110V69C1 68.4477 1.44772 68 2 68H277Z"
                fill="white"
            />
            <path
                id="mux-mem"
                d="M351 160C350.448 160 350 160.448 350 161C350 161.552 350.448 162 351 162V160ZM424 161L414 155.226V166.774L424 161ZM351 161V162H415V161V160H351V161Z" 
                fill="white"
            />
            <path
                id="mem-alu"
            ...
            <path
                id="mux-acc"
                d="M853 195C852.448 195 852 195.448 852 196C852 196.552 852.448 197 853 197V195ZM941.006 196L931.006 190.226V201.774L941.006 196ZM853 196V197H932.006V196V195H853V196Z"
                fill="white"
            />
            <path
                id="mem-mux"
                d="M770 101C770.552 101 771 101.448 771 102V173H806V168.227L816 174L806 179.773V175H770C769.448 175 769 174.552 769 174V103H589V174C589 174.552 588.552 175 588 175H518C517.448 175 517 174.552 517 174C517 173.448 517.448 173 518 173H587V103C587 102.818 587.05 102.647 587.135 102.5C587.05 102.353 587 102.182 587 102C587 101.448 587.448 101 588 101H770Z"
                fill="white"
            />
            <path
                id="alu-mux"
                d="M728 215C727.448 215 727 215.448 727 216C727 216.552 727.448 217 728 217V215ZM816 216L806 210.226V221.774L816 216ZM728 216V217H807V216V215H728V216Z"
                fill="white"
            />
            <path
                id="mem-ir"
                d="M588 173C588.09 173 588.178 173.013 588.261 173.035C588.271 173.038 588.282 173.04 588.293 173.043C588.374 173.068 588.45 173.104 588.521 173.147C588.532 173.155 588.544 173.161 588.556 173.169C588.585 173.189 588.613 173.21 588.64 173.232C588.661 173.25 588.682 173.268 588.702 173.288L588.707 173.293C588.716 173.302 588.724 173.313 588.733 173.322C588.746 173.335 588.758 173.348 588.77 173.362C588.802 173.401 588.83 173.443 588.856 173.486C588.864 173.498 588.871 173.51 588.878 173.522C588.914 173.588 588.942 173.659 588.963 173.732C588.969 173.754 588.975 173.776 588.979 173.799C588.987 173.833 588.992 173.869 588.995 173.904C588.998 173.934 589 173.964 589 173.994L589.992 330.88C589.997 330.919 590 330.959 590 331C590 331.552 589.552 332 589 332H78C77.8175 332 77.6473 331.95 77.5 331.864C77.3527 331.95 77.1825 332 77 332C76.4477 332 76 331.552 76 331V255C76 254.448 76.4477 254 77 254H111V249.227L121 255L111 260.773V256H78V330H587.987L587.006 175H518C517.448 175 517 174.552 517 174C517 173.448 517.448 173 518 173H588Z"
                fill="white"
            />
            <path
                id="acc-control"
            ...
            <circle cx="270" cy="255" r="5" fill="white"/>
